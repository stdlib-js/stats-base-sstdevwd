...
> Calculate the [standard deviation][standard-deviation] of a single-precision floating-point strided array using Welford's algorithm.
...
<!-- <div class="equation" align="center" data-raw-text="\sigma = \sqrt{\frac{1}{N} \sum_{i=0}^{N-1} (x_i - \mu)^2}" data-equation="eq:population_standard_deviation">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@191e80ea7ce5a449a2eed8f328eb4d8aae25ff1e/lib/node_modules/@stdlib/stats/base/sstdevwd/docs/img/equation_population_standard_deviation.svg" alt="Equation for the population standard deviation.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="\mu = \frac{1}{N} \sum_{i=0}^{N-1} x_i" data-equation="eq:population_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@191e80ea7ce5a449a2eed8f328eb4d8aae25ff1e/lib/node_modules/@stdlib/stats/base/sstdevwd/docs/img/equation_population_mean.svg" alt="Equation for the population mean.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="s = \sqrt{\frac{1}{n-1} \sum_{i=0}^{n-1} (x_i - \bar{x})^2}" data-equation="eq:corrected_sample_standard_deviation">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@191e80ea7ce5a449a2eed8f328eb4d8aae25ff1e/lib/node_modules/@stdlib/stats/base/sstdevwd/docs/img/equation_corrected_sample_standard_deviation.svg" alt="Equation for computing a corrected sample standard deviation.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="\bar{x} = \frac{1}{n} \sum_{i=0}^{n-1} x_i" data-equation="eq:sample_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@191e80ea7ce5a449a2eed8f328eb4d8aae25ff1e/lib/node_modules/@stdlib/stats/base/sstdevwd/docs/img/equation_sample_mean.svg" alt="Equation for the sample mean.">
    <br>
</div> -->
...
```javascript
sstdevwd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-sstdevwd@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-sstdevwd/tags). For example,

```javascript
sstdevwd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-sstdevwd@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var sstdevwd = require( 'path/to/vendor/umd/stats-base-sstdevwd/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-sstdevwd@umd/browser.js"></script>
```
...
Computes the [standard deviation][standard-deviation] of a single-precision floating-point strided array `x` using Welford's algorithm.
...
var v = sstdevwd( N, 1, x1, 2 );
// returns 2.5
```

#### sstdevwd.ndarray( N, correction, x, stride, offset )

Computes the [standard deviation][standard-deviation] of a single-precision floating-point strided array using Welford's algorithm and alternative indexing semantics.
...
var v = sstdevwd.ndarray( N, 1, x, 1, 0 );
// returns ~2.0817
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-sstdevwd.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-sstdevwd

[test-image]: https://github.com/stdlib-js/stats-base-sstdevwd/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/stats-base-sstdevwd/actions/workflows/test.yml?query=branch:v0.2.2

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-sstdevwd/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-sstdevwd?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-sstdevwd.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-sstdevwd/main
...
[deno-readme]: https://github.com/stdlib-js/stats-base-sstdevwd/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-sstdevwd/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-sstdevwd/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-sstdevwd/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-sstdevwd/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-sstdevwd/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-sstdevwd/main/LICENSE
